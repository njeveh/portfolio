    ...
    return (
        <>
            <div className="footer-container row mx-0">
                <div className=" indiv footer-first footer-div col-12 col-md-4">
                    <p>Elijah Mutemi<br />Software Developer</p>
                </div>
                <div className="link-icons footer-div col-12 col-md-4">
                ...
                <div className="footer-links footer-div col-12 col-md-4">
